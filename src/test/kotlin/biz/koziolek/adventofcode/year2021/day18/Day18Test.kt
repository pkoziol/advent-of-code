...
internal class Day18Test {
    ...
    @Test
    fun testFindMaxPossibleMagnitudeOfTwo() {
        val lines = """
            [[[0,[5,8]],[[1,7],[9,6]]],[[4,[1,2]],[[1,4],2]]]
            [[[5,[2,8]],4],[5,[[9,9],0]]]
            [6,[[[6,2],[5,6]],[[7,6],[4,7]]]]
        ...
        val (firstNum, secondNum, maxMagnitude) = findMaxPossibleMagnitudeOfTwo(numbers)
        assertEquals("[[2,[[7,7],7]],[[5,8],[[9,3],[0,2]]]]", firstNum.asText())
        assertEquals("[[[0,[5,8]],[[1,7],[9,6]]],[[4,[1,2]],[[1,4],2]]]", secondNum.asText())
        assertEquals(3993, maxMagnitude)
    }
    ...
    fun testAnswer2() {
        ...
        assertEquals(4633, maxMagnitude)
    }
}
