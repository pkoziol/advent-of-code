...
//        println(mapWithAntinodes)
    ...
    @Test
    fun testSampleAnswer2A() {
        val map = parseAntennasMap(sampleInputA.split("\n"))
        val mapWithAntinodes = map.addAntinodes(resonant = true)
        assertEquals(expectedOutputA2, AsciiColor.cleanUp(mapWithAntinodes.toString()))
        assertEquals(34, mapWithAntinodes.countUnique('#'))
    }

    @Test
    fun testSampleAnswer2C() {
        val map = parseAntennasMap(sampleInputC.split("\n"))
        val mapWithAntinodes = map.addAntinodes(resonant = true)
        assertEquals(expectedOutputC2, AsciiColor.cleanUp(mapWithAntinodes.toString()))
        assertEquals(9, mapWithAntinodes.countUnique('#'))
    }
    ...
    fun testAnswer2() {
        ...
        val antinodeCount = mapWithAntinodes.countUnique('#')
//        println(mapWithAntinodes)
        assertEquals(1352, antinodeCount)
    }
}
